...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_65_iso(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,    KC_SCLN, KC_QUOT,  KC_ENT,  KC_BSLS,  KC_HOME,
    ...
    KC_LCTL, KC_TRNS, KC_LALT,                          KC_SPC,                 KC_RWIN, MO(1), KC_TRNS,  KC_LEFT, KC_DOWN,  KC_RIGHT),

  [1] = LAYOUT_65_iso(
    /* esc      1        2        3        4       5       6       7       8       9         0        -         =     bkspc       `~  */
    KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,   KC_F10,  KC_F11,   KC_F12,  BS_NORM,   RGB_VAI,
    /*  tab      Q       W        E        R        T      Y        U      I        O        P        [         ]        \      delete*/
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,           RGB_HUI,
    /*  caps     A       S        D        F        G      H        J      K        L        ;        '       enter              pg up*/
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS,  RGB_TOG,  BS_SWAP,  RGB_SPI,
    /* shift             Z         X        C       V       B       N      M        ,        .        /        shift     up      pg dn*/
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_VOLU,  RGB_MOD,
    /* ctrl     win      alt                              space                    alt      fn       ctrl      left     down     right*/
